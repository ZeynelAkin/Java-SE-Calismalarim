...
public class Balik {
    ...
    {   String gocDurumBilgisi = "",mevsim = "";
        ...
        String sonuc="Göç Durumu = "+gocDurumBilgisi+" Rengi = "+this.rengi+" Omru = "+this.omur+" Yumurtlama Mevsimi = "+mevsim+" Uzunlugu = "+uzunluk+" ağırlık = "+agırlık;
        return sonuc;
    }protected String balikBilgisiniVer(int uzunluk,double agırlık)
    {   String gocDurumBilgisi = "",mevsim = "";
